...
namespace ThesisWork.Parsers
{
    class ScheduleParser
    {
        ...
        public static void ParseScheduleFromExcel(DataTableCollection data, PracticeRepository practiceRepository, ScheduleRepository scheduleRepository, CompetenceRepository competenceRepository)
        {
